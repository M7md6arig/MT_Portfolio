...
/**
 * Official brand glyphs that only exist as solid marks (X, Facebook's f, Behance's Bē)
...
export function IconLink({ href, label, icon }: IconLinkProps) {
  // "twitter" is a legacy alias for the X brand.
  const key = icon.toLowerCase() === "twitter" ? "x" : icon.toLowerCase();
  const filled = FILLED_ICONS[key];
